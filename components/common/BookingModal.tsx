...
export default function BookingModal({
  ...
  const modalContent = (
    ...
    >
      <div
        className="relative w-full max-w-md sm:max-w-lg rounded-[28px] border border-white/10 bg-gradient-to-b from-black/95 to-black/90 p-5 sm:p-7 text-white shadow-2xl max-h-[90vh] overflow-y-auto backdrop-blur-xl"
